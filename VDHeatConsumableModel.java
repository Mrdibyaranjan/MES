...
@Entity
@Table(name="TRNS_VD_HEAT_CONS_LINES")
@TableGenerator(name = "TRNS_VD_HEAT_CONS_LINES_SEQ_GEN", table = "SEQ_GENERATOR", pkColumnName = "COL_KEY", valueColumnName = "NEXT_VAL", pkColumnValue = "VdHeatConsSeqId", allocationSize = 1)
@DynamicUpdate(value=true)
@OptimisticLocking(type=OptimisticLockType.VERSION)
public class VDHeatConsumableModel  implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "TRNS_VD_HEAT_CONS_LINES_SEQ_GEN")
	...
	private VdAdditionsDetailsModel heatAdditionsDeatils;
	...
	public VdAdditionsDetailsModel getHeatarcingDeatils() {
		return heatAdditionsDeatils;
	}

	public void setHeatarcingDeatils(VdAdditionsDetailsModel heatAdditionsDeatils) {
		this.heatAdditionsDeatils = heatAdditionsDeatils;
	}
