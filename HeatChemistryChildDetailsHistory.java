...
@Entity
@Table(name="TRNS_HEAT_CHEMISTRY_CHILD_HISTORY")
@TableGenerator(name = "HEAT_CHEM_CHLD_HISTORY_SEQ_GEN", table = "SEQ_GENERATOR", pkColumnName = "COL_KEY", valueColumnName = "NEXT_VAL", pkColumnValue = "HeatChemChldHtrySeqId", allocationSize = 1)
@DynamicUpdate(value=true)
public class HeatChemistryChildDetailsHistory implements Serializable{
...
@Id
@GeneratedValue(strategy = GenerationType.TABLE, generator = "HEAT_CHEM_CHLD_HISTORY_SEQ_GEN")
@Column(name="CHEM_CHILD_HISTORY_ID")
private Integer chemChildHistoryId;
...
public Integer getChemChildHistoryId() {
	return chemChildHistoryId;
}

public void setChemChildHistoryId(Integer chemChildHistoryId) {
	this.chemChildHistoryId = chemChildHistoryId;
}

@Override
public String toString() {
	return "HeatChemistryChildDetailsHistory [chemChildHistoryId=" + chemChildHistoryId + ", dtls_si_no=" + dtls_si_no
			+ ", sample_si_no=" + sample_si_no + ", element=" + element + ", aim_value=" + aim_value + ", min_value="
			+ min_value + ", max_value=" + max_value + ", createdBy=" + createdBy + ", createdDateTime="
			+ createdDateTime + ", updatedBy=" + updatedBy + ", updatedDateTime=" + updatedDateTime + ", entryTime="
			+ entryTime + ", userId=" + userId + ", version=" + version + ", elementMstrLookupDtls="
			+ elementMstrLookupDtls + ", heatChemistryHdrDtls=" + heatChemistryHdrDtls + ", elementName=" + elementName
			+ ", uom=" + uom + ", psn_aim_value=" + psn_aim_value + ", remarks=" + remarks + ", spectro_flag="
			+ spectro_flag + ", sample_date=" + sample_date + "]";
}
