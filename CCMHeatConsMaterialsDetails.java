...
@Entity
@Table(name="TRNS_CCM_HEAT_CONS_MATERIALS")
@TableGenerator(name = "CCM_HEAT_CONS_MTRLS_SEQ_GEN", table = "SEQ_GENERATOR", pkColumnName = "COL_KEY", valueColumnName = "NEXT_VAL", pkColumnValue = "ccmHeatConsMtrlsSeqId", allocationSize = 1)
@DynamicUpdate(value=true)
@OptimisticLocking(type=OptimisticLockType.VERSION)
public class CCMHeatConsMaterialsDetails implements Serializable {
	
	 private static final long serialVersionUID = 1L;

		@Id
		@GeneratedValue(strategy = GenerationType.TABLE, generator = "CCM_HEAT_CONS_MTRLS_SEQ_GEN")
		...
		@ManyToOne(optional=true)
		@JoinColumn(name="TRNS_CCM_SI_NO" ,referencedColumnName="TRNS_SL_NO",insertable=false,updatable=false)
		private CCMHeatDetailsModel ccmTrnsModel;
		...
		public CCMHeatDetailsModel getCcmTrnsModel() {
			return ccmTrnsModel;
		}

		public void setCcmTrnsModel(CCMHeatDetailsModel ccmTrnsModel) {
			this.ccmTrnsModel = ccmTrnsModel;
		}
