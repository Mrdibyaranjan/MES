...
@Entity
@Table(name="TRNS_LRF_CONS_LINES_H")
@TableGenerator(name = "TRNS_LRF_CONS_LINE_H_SEQ_GEN", table = "SEQ_GENERATOR", pkColumnName = "COL_KEY", valueColumnName = "NEXT_VAL", pkColumnValue = "LrfConsHistSeqId", allocationSize = 1)
@DynamicUpdate(value=true)
@OptimisticLocking(type=OptimisticLockType.VERSION)
public class LRFHeatConsumableLogModel  implements Serializable{

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "TRNS_LRF_CONS_LINE_H_SEQ_GEN")
	@Column(name="LRF_CONS_LINES_H_ID")
	private Integer lrf_cons_log_sl_no;
	...
	public Integer getLrf_cons_log_sl_no() {
		return lrf_cons_log_sl_no;
	}

	public void setLrf_cons_log_sl_no(Integer lrf_cons_log_sl_no) {
		this.lrf_cons_log_sl_no = lrf_cons_log_sl_no;
	}
