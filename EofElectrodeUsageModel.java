...
@Entity
@Table(name = "TRNS_EOF_ELECTRODES_USAGE")
@TableGenerator(name = "TRNS_EOF_ELECTRODES_USAGE_SEQ_GEN", table = "SEQ_GENERATOR", pkColumnName = "COL_KEY", valueColumnName = "NEXT_VAL", pkColumnValue = "transEofElectrodesSeqId", allocationSize = 1)
@DynamicUpdate(value = true)
public class EofElectrodeUsageModel implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "TRNS_EOF_ELECTRODES_USAGE_SEQ_GEN")
	...
	@Column(name="EOF_HEAT_TRNS_ID")
	private Integer eofHeatTransId;
	...
	public Integer getEofHeatTransId() {
		return eofHeatTransId;
	}

	public void setEofHeatTransId(Integer eofHeatTransId) {
		this.eofHeatTransId = eofHeatTransId;
	}
}
